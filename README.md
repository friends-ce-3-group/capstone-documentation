...
The dependencies between the application and infrastructure components implemented in the separate repositories are as shown in the dependency graph below, where the "depends on" and "data from" relationships indicate resource deployment and logging data interdependencies respectively.
